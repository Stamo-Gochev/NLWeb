...
class IncrementalCrawler:
    ...
    async def _process_single_url(self, url: str) -> bool:
        ...
        try:
            ...
            docs, texts_for_embedding = prepare_documents_from_json(final_url, schemas_str, self.db_name)
            ...
            if documents_to_upload:
                ...
                # Use the properly extracted texts from prepare_documents_from_json
                # which extracts from 'text' field instead of full JSON
