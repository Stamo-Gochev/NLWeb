...
Now, using our debug tool, you can easily ask questions about your Github data in natural language.  Start your web server by running `python app-file.py` from the **code/python** directory.  Then in a web browser, navigate to http://localhost:8123/static/str_chat.html.  Select "behindthetech" from the site dropdown and your retrieval provider from the database dropdown (I am using "Qdrant Local").  Then ask questions in natural language.
...
Then in a web browser, navigate to http://localhost:8123/static/str_chat.html.  You can now ask questions of your data.
...
Open a web browser and navigate to http://localhost:8123/static/fp_chat.html.  You should be able to ask questions of this data.
